...
<?php
$result_user = "SELECT * FROM usuarios ORDER BY id ASC";
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="form-group">
                            <?php
                            if (isset($_GET['msgapaguser'])) {
                                echo $_GET['msgapaguser'];
                                unset($_GET['msgapaguser']);
                            }
                            ?>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-sm" id="usuario">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row_linha = mysqli_fetch_assoc($resultado_user)) {
                                                ?>                                              
                                                <tr style="white-space: nowrap;">
                                                    <th scope="row" class="text-center"><?php echo $row_linha['id']; ?></th>
                                                    <td class="text-center"><?php echo $row_linha['nome']; ?></td>
                                                    <td class="text-center"><?php echo $row_linha['usuario']; ?></td>
                                                    <td class="text-center"><?php echo $row_linha['email']; ?></td>
                                                    <td class="text-center"><?php echo $row_linha['matricula']; ?></td>
                                                    <td class="text-center"><?php echo $row_linha['cargo']; ?></td>
                                                    <td class="text-center"><?php echo $row_linha['acesso']; ?></td>
                                                    <td class="text-center"><?php echo $row_linha['criadoem']; ?></td>
                                                    <td class="text-center">
                                                        <span class="d-none d-md-block">
                                                            <a href="include/editar-usuario.php?id=<?php echo $row_linha['id']; ?>" class="btn btn-warning btn-sm">Editar</a>
                                                            <a href="include/apagar-usuario.php?id=<?php echo $row_linha['id']; ?>" class="btn btn-danger btn-sm">Excluir</a>
                                                        </span>
                                                    </td>
                                                </tr>
                                            <?php }
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="include/apagar-usuario.php?id=<?php echo $row_linha['id']; ?>" type="button" class="btn btn-danger" id="delete">Apagar</a>
                    </div>
                </div>
            </div>
        </div>-->
